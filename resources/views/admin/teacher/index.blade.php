...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Teacher /</span> Manages
    </h4>
    ...
    <div class="card">
        <div class="card-header">
            ...
            {{-- <div class="float-end">
                @can('admin-access-policy.perform', 'add-teacher')
                    <a href="{{ route('admin.teacher.create') }}" class="add-new btn btn-primary mb-3 mb-md-0"> Add
                        New</a>
                @endcan
                @can('admin-access-policy.perform', 'delete-teacher')
                    <a href="{{ route('admin.teacher.trash') }}" class="add-new btn btn-danger mb-3 mb-md-0">
                        Trash</a>
                @endcan
            </div> --}}
        </div>
        <div class="card-header border-bottom">
            <form action="" method="get" class="row">
                ...
                <div class="col-md-3 mt-3">
                    ...
                    <a href="{{ route('admin.teacher.index') }}" class="btn btn-primary">Reset</a>
                </div>
            </form>
        </div>
                        ...
                        @foreach ($dataProvider as $key => $data)
                            <tr>
                                ...
                                <td><span
                                        ...
                                        data-action="{{ route('admin.teacher.change-status', $data->uuid) }}"
