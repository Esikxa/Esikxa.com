...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Coupons /</span> Edit
    </h4>
    <div class="row">
        <!-- FormValidation -->
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form" class="row g-3" method="POST"
                        action="{{ route('admin.coupon.update', $model->uuid) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-12">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Coupon Code" id="code"
                                    name="code" value="{{ old('code',$model->code) }}" aria-label="Coupon Code"
                                    aria-describedby="generate-code" readonly>
                                <button class="btn btn-primary disabled" type="button" id="generate-code">Generate Coupon
                                    Code</button>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
