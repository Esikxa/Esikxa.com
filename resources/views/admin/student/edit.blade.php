...
@section('content')
    ...
    <!-- FormValidation -->
    <form id="form" class="row g-3" method="POST" action="{{ route('admin.customer.update', $model->uuid) }}"
            ...
            <div class="card">
                <div class="card-body row">
                        ...
                        <select name="client_id" id="client_id" class="form-control form-select">
                            ...
                            @foreach ($clients as $client)
                                <option value="{{ $client->id }}"
                                    {{ old('client_id', $model->client_id) == $client->id ? 'selected' : '' }}>
                                    {{ $client->title }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" id="subscriber_id" class="form-control" name="subscriber_id"
                            value="{{ old('subscriber_id', $model->subscriber_id) }}" />
                    </div>
                    <div class="col-md-6 mb-2">
                    ...
                    <div class="col-sm-6 mb-2 form-password-toggle password-div d-none">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="password" id="confirm-password" name="confirmation_password" class="form-control"
                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
