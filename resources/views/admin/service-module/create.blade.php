...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Service Modules /</span> Add New
</h4>

<!-- FormValidation -->
<form id="form" class="" method="POST" action="{{ route('admin.service-module.store') }}" enctype="multipart/form-data">
    <div class="row">
        <div class="col-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <input type="text" id="title" class="form-control" placeholder="Title of the service module" name="title" />
                    </div>
                    <div class="col-md-12">
