...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Banner /</span> Add New
    </h4>
        <!-- FormValidation -->
        <form id="form" class="row g-3" method="POST" action="{{ route('admin.banner.store') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" name="show_title" class="form-check-input" id="show_title"
                                value="{{ ConstantHelper::STATUS_ACTIVE }}"
                                {{ old('show_title') == ConstantHelper::STATUS_ACTIVE ? 'checked' : '' }}>
                            <label class="form-check-label" for="show_title">Show Title ?</label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" name="show_prefix_title" class="form-check-input"
                                id="show_prefix_title" value="{{ ConstantHelper::STATUS_ACTIVE }}"
                                {{ old('show_prefix_title') == ConstantHelper::STATUS_ACTIVE ? 'checked' : '' }}>
                            <label class="form-check-label" for="show_prefix_title">Show Prefix Title ?</label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" name="show_suffix_title" class="form-check-input"
                                id="show_suffix_title" value="{{ ConstantHelper::STATUS_ACTIVE }}"
                                {{ old('show_suffix_title') == ConstantHelper::STATUS_ACTIVE ? 'checked' : '' }}>
                            <label class="form-check-label" for="show_suffix_title">Show Suffix Title ?</label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" name="show_description" class="form-check-input"
                                id="show_description" value="{{ ConstantHelper::STATUS_ACTIVE }}"
                                {{ old('show_description') == ConstantHelper::STATUS_ACTIVE ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" name="show_button" class="form-check-input" id="show_button"
                                value="{{ ConstantHelper::STATUS_ACTIVE }}"
                                {{ old('show_button') == ConstantHelper::STATUS_ACTIVE ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" name="target" class="form-check-input" id="target"
                                value="{{ ConstantHelper::STATUS_ACTIVE }}"
                                {{ old('target') == ConstantHelper::STATUS_ACTIVE ? 'checked' : '' }}>
