...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Subject /</span> Edit
    </h4>
    <!-- FormValidation -->
    <form id="form" class="row g-3" method="POST" action="{{ route('admin.subject.update', $model->uuid) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="form-check form-switch mb-2">
                        <input type="checkbox" name="popular" class="form-check-input" id="popular"
                            value="{{ ConstantHelper::STATUS_ACTIVE }}"
                            {{ old('popular', $model->popular) == ConstantHelper::STATUS_ACTIVE ? 'checked' : '' }}>
