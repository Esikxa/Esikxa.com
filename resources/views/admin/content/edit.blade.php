...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Content /</span> Add Update
    </h4>
    <!-- FormValidation -->
    <form id="form" class="row g-3" method="POST" action="{{ route('admin.content.update', $model->uuid) }}"
        ...
        <div class="col-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12 mb-2">
                        <label class="form-label" for="prefix_title">Excerpt</label>
