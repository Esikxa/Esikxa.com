...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">clients /</span> Trash
    </h4>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-end">
                <a href="{{ route('admin.client.index') }}" class="add-new btn btn-primary mb-3 mb-md-0">
                    Go Back</a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-icon btn-primary btn-restore"
                                    data-action="{{ route('admin.client.restore', $item->uuid) }}" href="#"
                                    title="Restore"><i class="ti ti-refresh-alert"></i></a>
                                <a class="btn btn-icon btn-danger btn-delete"
                                    data-action="{{ route('admin.client.force-delete', $item->uuid) }}" href="#"
