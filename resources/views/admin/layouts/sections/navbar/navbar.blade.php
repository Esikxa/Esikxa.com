                ...
                <div class="dropdown-shortcuts-list scrollable-container">
                    <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                            ...
                            <a href="{{ route('admin.dashboard.index') }}" class="stretched-link">Dashboard</a>
                            <small class="text-muted mb-0">Overview</small>
                        </div>
                        @can('admin-access-policy.perform', 'view-role')
                            <div class="dropdown-shortcuts-item col">
                                <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                    <i class="ti ti-lock fs-4"></i>
                                </span>
                                <a href="{{ route('admin.role.index') }}" class="stretched-link">Role Management</a>
            ...
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                    @if (Auth::guard('admin')->check() && Auth::guard('admin')->user()->avatar)
                        <img src="{{ Auth::guard('admin')->user()->avatar }}" alt class="h-auto rounded-circle">
                    @else
                        @php
                            $words = explode(' ', Auth::guard('admin')->check() ? Auth::guard('admin')->user()->full_name : 'John Doe');
                        ...
                        @endphp
                        <span class="avatar-initial rounded-circle bg-label-success">{{ strlen($initials) > 2  ? substr($initials, 0, 2) : $initials }}</span>
                    @endif
                </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar avatar-online">
                                    ...
                                    @else
                                        ...
                                        @endphp
                                        <span
                                            class="avatar-initial rounded-circle bg-label-success">{{ strlen($initials) > 2  ? substr($initials, 0, 2) : $initials }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="flex-grow-1">
