...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        ...
        <!-- FormValidation -->
        <form id="form" class="row g-3" method="POST" action="{{ route('admin.testimonial.update', $model->uuid) }}"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <textarea id="message" class="form-control" name="message">{{ old('message', $model->message) }}</textarea>
                        </div>
                        <div class="col-md-12 mb-2">
