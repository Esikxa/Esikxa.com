    ...
    <div class="main-sidebar-loggedin">
        <div class="app-sidebar__user">
            <div class="dropdown user-pro-body text-center">
                <div class="user-pic">
                    <img src="{{ auth('student')->user()->avatar ? '' : asset('frontend/dashboard/assets/img/faces/default.jpg') }}"
                        alt="user-img" class="rounded-circle mCS_img_loaded">
                </div>
                <div class="user-info">
                    <h6 class=" mb-0 text-dark">{{ auth('student')->user()->full_name }}</h6>
                    <span class="text-muted app-sidebar__user-name text-sm">Student</span>
                </div>
            </div>
        </div>
    </div><!-- /user -->
