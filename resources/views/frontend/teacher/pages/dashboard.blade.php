@extends('frontend.teacher.layouts.app')
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="card overflow-hidden project-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="my-auto">
                                <svg enable-background="new 0 0 477.849 477.849" class="mr-4 ht-60 wd-60 my-auto success"
            ...
            <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                <div class="card overflow-hidden">
                    <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                        ...
                        <p class="tx-12 text-muted mb-2">The Project Budget is a tool used by project managers
                            to estimate the total cost of a project. A project budget template includes a
                            detailed estimate of all costs. <a href="#">Learn more</a></p>
                    </div>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body pb-3">
                        ...
                        <p class="tx-12 text-muted mb-3">In project, a task is an activity that needs to be
                            accomplished within a defined period of time or by a deadline. <a href="#">Learn more</a>
                        </p>
                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="project-names">
                                                <h6 class="bg-pink-transparent text-pink d-inline-block text-center mr-2">
                                                    R</h6>
                    ...
                    <div class="">
                        ...
                        <div class="">
                            <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-bold" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" data-toggle="tab" href="#tasktab-1" role="tab"
                                        aria-selected="false">
                                        Today
                                    </a>
                                </li>
                ...
                <div class="card overflow-hidden">
                    <div class="card-header pb-0">
                        ...
                        <p class="tx-12 text-muted mb-0"> In the Project Workload report, their remaining
                            assignments, completion dates, whether their work is at-risk. <a href="#">Learn more</a>
                        </p>
                    </div>
                    <div class="card-body">
                        <div class="">
                            ...
                            <div class="row ">
                                <div class="col-sm-8 ">
                                    <h6 class="mb-0 tx-15 d-flex"><span
                                            class="legend bg-primary-gradient brround"></span><span
                                            class="ml-3">40.32%</span></h6>
                        ...
                        <div class="pt-3">
                            <div class="row ">
                                <div class="col-sm-8 ">
                                    <h6 class="mb-0 tx-15 d-flex"><span
                                            class="legend bg-warning-gradient brround"></span><span
                                            class="ml-3">40.73%</span></h6>
                        ...
                        <div class="pt-3">
                            <div class="row ">
                                <div class="col-sm-8 ">
                                    <h6 class="mb-0 tx-15 d-flex"><span
                                            class="legend bg-success-gradient brround"></span><span
                                            class="ml-3">50.12%</span></h6>
            ...
            <div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
                <div class="card card-dashboard-events">
                    <div class="card-header pb-0">
                        ...
                        <p class="tx-12 text-muted mb-0">It had the latest news and notes from the
                            championship, while previewing the upcoming event.. <a href="#">Learn
                                more</a></p>
                    </div>
                    <div class="card-body">
                        <div class="list-group ">
                            ...
                            <div class="list-group-item">
                                ...
                                <p><strong>8AM - 5PM</strong> Singapore</p><small><span class="tx-warning">Sold
                                        Out Soon</span> (12 tickets left)</small>
                            </div>
                            <div class="list-group-item border-bottom-0">
                                ...
                                <p><strong>8AM - 5PM</strong> Singapore</p><small><span class="tx-success">Free
                                        Registration</span> (Limited seats
                                    only)</small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12 col-xl-12">
                <div class="card overflow-hidden review-project">
                    <div class="card-body">
                        ...
                        <p class="tx-12 text-muted mb-3">A project is an activity to meet the creation of a
                            unique product or service and thus activities that are undertaken to accomplish
                            routine activities cannot be considered projects. <a href="#">Learn more</a>
                        </p>
                            ...
                            <table
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround"
                                                    alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/11.jpg') }}"><img
                                                    class="profile-img brround " alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/12.jpg') }}"><img
                                                    class="profile-img brround" alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/2.jpg') }}">
                                            </div>
                                        </td>
                                        <td>Web Design</td>
                                        <td>01 Jan 2020</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround"
                                                    alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/16.jpg') }}"><img
                                                    class="profile-img brround " alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/8.jpg') }}"><img
                                                    class="profile-img brround" alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/7.jpg') }}">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround"
                                                    alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/3.jpg') }}"><img
                                                    class="profile-img brround " alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/12.jpg') }}"><img
                                                    class="profile-img brround" alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/15.jpg') }}">
                                            </div>
                                        </td>
                                        <td>Web Development</td>
                                        <td>15 March 2020</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround"
                                                    alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/7.jpg') }}"><img
                                                    class="profile-img brround " alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/6.jpg') }}"><img
                                                    class="profile-img brround" alt="profile image"
                                                    src="{{ asset('frontend/dashboard/assets/img/faces/16.jpg') }}">
                                            </div>
                                        </td>
                                        <td>Android</td>
                                        <td>15 March 2020</td>
            ...
            <div class="col-lg-12 col-xl-4 col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 pt-4">
                        ...
                        <p class="tx-12 text-muted mb-0">Project Description is a formally written declaration
                            of the project and its idea and context . <a href="#">Learn more</a></p>
                    </div>
                        ...
                        <div class="list-group projects-list">
                            <a href="#"
                                ...
                                <div class="d-flex w-100 justify-content-between">
                                    ...
                                    <small class="text-danger"><i class="fa fa-caret-down mr-1"></i>5 days
                                        ago</small>
                                </div>
                            ...
                            <a href="#"
                                ...
                                <div class="d-flex w-100 justify-content-between">
                                    ...
                                    <small class="text-success"><i class="fa fa-caret-up mr-1"></i>2 days
                                        ago</small>
                                </div>
                            ...
                            <a href="#"
                                ...
                                <div class="d-flex w-100 justify-content-between">
                                    ...
                                    <small class="text-danger"><i class="fa fa-caret-down mr-1"></i>1 days
                                        ago</small>
                                </div>
                    ...
                    <div class="card-body p-0">
                        <div class="activity Activity-scroll">
                            <div class="activity-list">
                                <img src="{{ asset('frontend/dashboard/assets/img/faces/6.jpg') }}" alt=""
                                    class="img-activity">
                                <div class="time-activity ">
                                    <div class="item-activity">
                                        <p class="mb-0"><span class="h6 mr-1">Adam Berry</span><span
                                                class="text-muted tx-13"> Add a new projects</span> <span
                                                class="h6 ml-1 added-project"> AngularJS Template</span></p>
                                        <small class="text-muted ">30 mins ago</small>
                                    </div>
                                </div>
                                <img src="{{ asset('frontend/dashboard/assets/img/faces/9.jpg') }}" alt=""
                                    class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                        <p class="mb-0"><span class="h6 mr-1">Irene Hunter</span> <span
                                                class="text-muted tx-13"> Add a new projects</span> <span
                                                class="h6 ml-1 added-project text-danger">Free HTML
                                                Template</span></p><small class="text-muted ">1 days
                                            ago</small>
                                    </div>
                                </div> <img src="{{ asset('frontend/dashboard/assets/img/faces/3.jpg') }}" alt=""
                                    class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                        <p class="mb-0"><span class="h6 mr-1">John Payne</span> <span
                                                class="text-muted tx-13"> Add a new projects</span> <span
                                                class="h6 ml-1 added-project text-success">Free PSD
                                                Template</span></p><small class="text-muted ">3 days
                                            ago</small>
                                    </div>
                                </div> <img src="{{ asset('frontend/dashboard/assets/img/faces/4.jpg') }}" alt=""
                                    class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity ">
                                        <p class="mb-0"><span class="h6 mr-1">Julia Hardacre</span> <span
                                                class="text-muted tx-13"> Add a new projects</span> <span
                                                class="h6 ml-1 added-project text-warning">Free UI
                                                Template</span></p><small class="text-muted ">5 days
                                            ago</small>
                                    </div>
                                </div> <img src="{{ asset('frontend/dashboard/assets/img/faces/5.jpg') }}" alt=""
                                    class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                        <p class="mb-0"><span class="h6 mr-1">Adam Berry</span> <span
                                                class="text-muted tx-13"> Add a new projects</span> <span
                                                class="h6 ml-1 added-project text-pink"> AngularJS
                                                Template</span></p><small class="text-muted ">30 mins
                                            ago</small>
                                    </div>
                                </div> <img src="{{ asset('frontend/dashboard/assets/img/faces/6.jpg') }}" alt=""
                                    class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                        <p class="mb-0"><span class="h6 mr-1">Irene Hunter</span> <span
                                                class="text-muted tx-13"> Add a new projects</span> <span
                                                class="h6 ml-1 added-project text-purple">Free HTML
                                                Template</span></p><small class="text-muted ">1 days
                                            ago</small>
                                    </div>
                                </div> <img src="{{ asset('frontend/dashboard/assets/img/faces/16.jpg') }}"
                                    alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                        <p class="mb-0"><span class="h6 mr-1">John Payne</span><span
                                                class="text-muted tx-13"> Add a new projects</span> <span
                                ...
                                </div> <img src="{{ asset('frontend/dashboard/assets/img/faces/10.jpg') }}"
                                    alt="" class="img-activity">
                                <div class="time-activity mb-0">
                                    <div class="item-activity mb-0">
                                        <p class="mb-0"><span class="h6 mr-1">Julia Hardacre</span><span
                                                class="text-muted tx-13"> Add a new projects</span><span
                                                class="h6 ml-1 added-project">Free UI Template</span></p>
            ...
            <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card">
                    <div class="card-header pt-4 pb-0">
                        ...
                        <p class="tx-12 text-muted mb-0">The Statistics You can also summarize your data in a
                            graphical display, such as histograms <a href="#">Learn more</a> </p>
                    </div>
                    ...
                    <div class="task-stat pb-0">
                        <div class="d-flex tasks">
                            <div class="mb-0">
                                <div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-primary mr-2"></i>Completed
                                    Tasks</div>
                        ...
                        <div class="d-flex tasks">
                            <div class="mb-0">
                                <div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Inprogress
                                    Tasks</div>
                                <span class="text-muted tx-11 ml-4">8:00am - 10:30am</span>
                            </div>
                        ...
                        <div class="d-flex tasks">
                            <div class="mb-0">
                                <div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-success mr-2"></i>On Hold
                                    Tasks</div>
                                <span class="text-muted tx-11 ml-4">8:00am - 10:30am</span>
                            </div>
                        ...
                        <div class="d-flex tasks mb-0 border-bottom-0">
                            <div class="mb-0">
                                <div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Pending Tasks
                                </div>
                                <span class="text-muted tx-11 ml-4">8:00am - 10:30am</span>
                            </div>
